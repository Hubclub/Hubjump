...
public class Enviroment {
	...
	public final static float VP_WIDTH = 12*Gdx.graphics.getWidth() / 480f;
	public final static float VP_HEIGHT = 20*Gdx.graphics.getHeight() / 800f;
	...
	public Enviroment (){
		this.world =(new World(new Vector2(0, GRAVITATIONAL_ACCELERATION), true));
			ninja = new Ninja();
			ninja.setBody(world, WallSegment.WALL_WIDTH + WallSegment.STAIR_WIDTH/2f - Ninja.NINJA_WIDTH/2, 6f);
